...
Say **"Captain"** (or "wake up, Captain"). JARVIS answers *"Yes, sir"*, the corner
...
**Requirements:** Chrome (other browsers may throttle recognition in a
background tab, or lack the API entirely — JARVIS then disables itself and the
rest of the site is unaffected). Needs microphone permission and an
HTTPS/localhost origin, which the GitHub Pages URL satisfies.
